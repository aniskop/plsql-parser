declare
    ...
    function my_func(param1 in varchar2) return number;
    ...
    function my_func(p1 number := 10, p2 pls_integer default 256) return pls_integer pipelined parallel_enable deterministic result_cache;
